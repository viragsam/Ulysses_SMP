KPL/FK
   ...
   Original file name:                   moon_de440_250416.tf
   Creation date:                        2025 April 16 05:09
   ...
   Version description:
      ...
      This frame kernel differs from the previous version

         moon_pa_de440_220930.tf

      in that the ID codes of the alias frames

         MOON_PA
         MOON_ME
 
      have been reset to their respective, original values 

         31000
         31001 

      These codes will remain unchanged in future revisions of this kernel.
   ...
   -------------------------   -----------------    -----  --------
   MOON_PA                     MOON_PA_DE440        FIXED  31000
   MOON_ME                     MOON_ME_DE440_ME421  FIXED  31001
   ...
   \begindata
      ...
      TKFRAME_31000_RELATIVE        = 'MOON_PA_DE440'
